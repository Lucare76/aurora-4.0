...
import icon from '../assets/aurora-icon.png';
import './Login.css';
          ...
          <div className="login-header">
            <div className="logo-premium">
              <div className="logo-icon-premium">
                <img src={icon} alt="Aurora" className="logo-image-premium" />
          ...
          <div className="login-footer">
            {!showResetPassword ? (
              ...
              <div className="reset-password-panel">
                <h3 className="reset-title">Recupera Password</h3>
                ...
                <form onSubmit={handleResetPassword} className="reset-form">
                  ...
                  <div className="reset-actions">
                    <button type="button" className="reset-cancel-btn" onClick={() => { setShowResetPassword(false); setResetMessage(''); }}>
                      Annulla
                    </button>
                ...
                {resetMessage === 'success' && (
                  <div className="reset-success">
                    Email inviata! Controlla la casella di posta e la cartella <strong>Spam/Posta indesiderata</strong>. Il mittente è noreply@aurora-4-0.firebaseapp.com
                  </div>
                )}
                {resetMessage === 'error' && (
                  <div className="reset-error">
                    Impossibile inviare l'email. Verifica l'indirizzo e riprova.
                  </div>
                )}
              </div>
            )}
